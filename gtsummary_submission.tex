...
The \code{tbl\_regression()} function leverages the huge effort behind the \pkg{broom} and \CRANpkg{broom.helpers} packages to perform the initial formatting of the regression object \citep{broom,broom.helpers}.
