...
tibble::tribble(
  ...
  as_latex() %>%
  as.character() %>%
  str_replace(fixed("\\toprule"), fixed("\\caption{\\label{tab:}\\texttt{tbl_summary()} function arguments}\\\\\n\\toprule")) %>%
...
tibble::tribble(
  ...
  as_latex() %>%
  as.character() %>%
  str_replace(fixed("\\toprule"), fixed("\\caption{\\label{tab:}\\texttt{tbl_summary()} functions to add information}\\\\\n\\toprule")) %>%
