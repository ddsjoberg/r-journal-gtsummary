...
While other R packages are available to clean and present summary statistics and regression results in statistical reports, \pkg{gtsummary} is unique https://www.overleaf.com/project/5fd126ae12e0e68e74c14832in that it is a one-stop-shop for all types of statistical tables and offers diverse features to customize content and format of tables to a high degree.
